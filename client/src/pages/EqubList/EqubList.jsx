...
import EqubHeader from "../../components/EqubList/EqubHeader";
import EqubCard from "../../components/EqubList/EqubCard";
...
const EqubList = () => {
  ...
  return (
    <div className="mb-6 mt-5 md:px-8 overflow-x-hidden">
      {/* Header */}
      ...
      {filteredEqubs.length > 0 ? (
        ...
        <p className="text-gray-500 mt-4">No equbs found 🚫</p>
      )}
    </div>
  );
};
